...
public class CarCamm : MonoBehaviour
{
    Transform carCam;
    Transform car;
    ...
    public float cameraStickiness = 100.0f;
    ...
    void FixedUpdate()
    {
        ...
        Vector3 targetCarPosition = new Vector3(car.position.x, car.position.y + 1, car.position.z - 3);
